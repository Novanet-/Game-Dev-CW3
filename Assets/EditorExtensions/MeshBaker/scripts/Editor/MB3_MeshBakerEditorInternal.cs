		...
		public static bool bake(MB3_MeshBakerCommon mom){
			...
			//try{
				...
				if (mom.meshCombiner.outputOption == MB2_OutputOptions.bakeIntoSceneObject){
					success = MB3_MeshBakerEditorFunctions.BakeIntoCombined(mom,new MB3_EditorMethods());
					...
					if (mom is MB3_MeshBaker){
						...
						Mesh m = MB3_BakeInPlace.BakeMeshesInPlace((MB3_MeshCombinerSingle)((MB3_MeshBaker)mom).meshCombiner, objsToMesh, mom.bakeAssetsInPlaceFolderPath, new MB3_EditorMethods(), updateProgressBar);
